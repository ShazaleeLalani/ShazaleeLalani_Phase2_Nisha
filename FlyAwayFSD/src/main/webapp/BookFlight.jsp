...
<%
    Booking.flight_booking = request.getParameter("FlightID");
...
<div class="w3-bar w3-white w3-card" id="myNavbar">
    <a href="" class="w3-bar-item w3-button w3-wide"><img src="Images/Logo.jpg" class="img-fluid" alt="image" width="18%">  FlyAway</a>

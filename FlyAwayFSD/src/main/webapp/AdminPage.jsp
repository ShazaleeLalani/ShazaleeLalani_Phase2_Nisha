...
<body>
    ...
    <header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
        ...
        <div class="w3-display-left w3-text-white" style="padding:48px">
            ...
            <p><a href="LoginPage.jsp" class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-on"><i class="fa fa-gear"></i>   Admin Login</a></p>
        </div>
    </header>
    <div class="footer">
